...
// === PERFORMANCE ACTIONS ===
{
  ...
  testCases.push(
    ...
    // === ACTION ===
    { scenario: 'ACTION: start_profiling', toolName: 'system_control', arguments: {"action": "start_profiling"}, expected: 'success' },
    // === PLAYBACK ===
    { scenario: 'PLAYBACK: stop_profiling', toolName: 'system_control', arguments: {"action": "stop_profiling"}, expected: 'success' },
    // === ACTION ===
    { scenario: 'ACTION: run_benchmark', toolName: 'system_control', arguments: {"action": "run_benchmark", "duration": 1}, expected: 'success' },
    ...
    { scenario: 'ACTION: generate_memory_report', toolName: 'system_control', arguments: {"action": "generate_memory_report"}, expected: 'success|already exists' },
    // === CONFIG ===
    ...
    // === CONFIG ===
    { scenario: 'CONFIG: configure_texture_streaming', toolName: 'system_control', arguments: {"action": "configure_texture_streaming"}, expected: 'success' },
    { scenario: 'CONFIG: configure_lod', toolName: 'system_control', arguments: {"action": "configure_lod"}, expected: 'success' },
    // === ACTION ===
    ...
    { scenario: 'ACTION: optimize_draw_calls', toolName: 'system_control', arguments: {"action": "optimize_draw_calls"}, expected: 'success' },
    { scenario: 'ACTION: merge_actors', toolName: 'system_control', arguments: {"action": "merge_actors", "actors": ["ParentActor", "ChildActor"], "replaceSourceActors": false, "packageName": MERGED_ACTOR_ASSET}, expected: 'success' },
    // === CONFIG ===
    ...
    { scenario: 'CONFIG: configure_world_partition', toolName: 'system_control', arguments: {"action": "configure_world_partition"}, expected: 'success' },
